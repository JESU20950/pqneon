#ifndef PQCLEAN_FALCON512_NEON_API_H
#define PQCLEAN_FALCON512_NEON_API_H

#include <stddef.h>
#include <stdint.h>

#define PQCLEAN_FALCON512_NEON_CRYPTO_SECRETKEYBYTES   1281
#define PQCLEAN_FALCON512_NEON_CRYPTO_PUBLICKEYBYTES   897
#define PQCLEAN_FALCON512_NEON_CRYPTO_BYTES            690

#define PQCLEAN_FALCON512_NEON_CRYPTO_ALGNAME          "Falcon-512"

/*
 * Generate a new key pair. Public key goes into pk[], private key in sk[].
 * Key sizes are exact (in bytes):
 *   public (pk): PQCLEAN_FALCON512_NEON_CRYPTO_PUBLICKEYBYTES
 *   private (sk): PQCLEAN_FALCON512_NEON_CRYPTO_SECRETKEYBYTES
 *
 * Return value: 0 on success, -1 on error.
 */
int PQCLEAN_FALCON512_NEON_crypto_sign_keypair(
 ...
 * (in bytes) is PQCLEAN_FALCON512_NEON_CRYPTO_BYTES.
 *
 * sig[], m[] and sk[] may overlap each other arbitrarily.
 *
 * Return value: 0 on success, -1 on error.
 */
int PQCLEAN_FALCON512_NEON_crypto_sign_signature(
 ...
 * Return value: 0 on success, -1 on error.
 */
int PQCLEAN_FALCON512_NEON_crypto_sign_verify(
 ...
 * (mlen) by up to PQCLEAN_FALCON512_NEON_CRYPTO_BYTES.
 *
 ...
 * Return value: 0 on success, -1 on error.
 */
int PQCLEAN_FALCON512_NEON_crypto_sign(
 ...
 * may range up to PQCLEAN_FALCON512_NEON_CRYPTO_BYTES.
 *
 * m[], sm[] and pk[] may overlap each other arbitrarily.
 *
 * Return value: 0 on success, -1 on error.
 */
int PQCLEAN_FALCON512_NEON_crypto_sign_open(
